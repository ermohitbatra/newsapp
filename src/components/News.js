...
export class News extends Component {
  ...
  async updateNews() {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=d5c3ad2ed4e849c8b4ac3ee935a3d901&page=${this.state.page}&pageSize=${this.props.pageSize}`;
